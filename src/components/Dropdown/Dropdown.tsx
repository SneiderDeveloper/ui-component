...
import {
  DropdownProps, Section, Item, } from './interfaces/dropdown.interface.ts';
...
export const Dropdown: FC<DropdownProps> = ({
  ...
  const selectedValue = useMemo(
    () => {
    const selectedOption = getSelectedLabels({ sections, selectedKeys });
    if (setSelectedOption) setSelectedOption(selectedOption)
      ...
      <DropdownTrigger>
        ...
        user ? (
          ...
          <Button
            ...
            className='p-4'
          >
            { dropdownMenu?.selectionMode ? selectedValue :
            title}
          </Button>
         )
        }
